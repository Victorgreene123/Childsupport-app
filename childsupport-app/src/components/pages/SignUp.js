            ...
            <div className='row'>
                ...
                <h2>Create account</h2>
                        ...
                        <div className='form-input'>
                            ...
                            <button className ='witgoogle'><span className='google-container'><img src='../../../public/google.png' alt='google icon'/> <span className='signgoogle'>Sign up with Google</span></span></button>
