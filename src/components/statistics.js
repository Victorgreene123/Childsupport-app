...
<div className='statscontainer'>
    <div className='stat'>
        <h5 className='statname'> <span className='bullet'>&#9702;</span>Donations</h5>
    <div className='general-row'>
        <div className='stat-division-1'>
     <h5  className='division-title'>Donations Made</h5>
     <h4 className='stat-value'>50</h4>
     </div>
     <div className='stat-division-2'>
     <h5 className='division-title'>Donations Granted </h5>
