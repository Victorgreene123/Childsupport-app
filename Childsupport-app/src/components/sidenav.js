...
<div className='sidenav'>
  ...
  <ul className='sections'>
    ...
    <a className='sections-link' id='settings'><span className='sectionlinkholder'>
        <img src='http://localhost:3000/images/settings.png' className='sectionlinkicon'></img>
  ...
  <div className='aside'>
   ...
   <a className='sections-link logout'> <span className='sectionlinkholder'>
        <img src='http://localhost:3000/images/logout-1.png' className='sectionlinkicon'></img>
